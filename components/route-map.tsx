...
export default function RouteMap() {
  ...
  useEffect(() => {
    ...
    import("leaflet").then(({ default: L }) => {
      ...
      L.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png", { attribution: '&copy; OpenStreetMap contributors &copy; CARTO', subdomains: "abcd", maxZoom: 20 }).addTo(map);
