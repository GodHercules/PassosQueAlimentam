        ...
        <section className="road-stop-section map-stop" id="largada">
          <div className="container route-briefing">
            ...
            <div className="route-briefing-grid">
              <div className="map-frame"><iframe title="Mapa do percurso da Corrida Passos que Alimentam" src="https://www.google.com/maps?q=-12.996842,-38.442875&z=14&output=embed" loading="lazy" /><div className="route-map-overlay" aria-hidden="true"><svg viewBox="0 0 100 100" preserveAspectRatio="none"><path d="M24 72 C34 69 45 61 54 50 S67 29 78 17 S67 34 55 52 S40 67 24 72" /></svg><span className="map-route-label map-route-meeting">ENCONTRO</span><span className="map-route-label map-route-start">LARGADA</span><span className="map-route-label map-route-turn">RETORNO</span><i className="map-route-dot dot-meeting" /><i className="map-route-dot dot-start" /><i className="map-route-dot dot-turn" /></div></div>
