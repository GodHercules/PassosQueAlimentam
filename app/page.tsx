        ...
        <section className="road-stop-section map-stop" id="largada">
          <div className="container route-briefing">
            ...
            <div className="route-briefing-grid">
              <div className="map-frame"><iframe title="Mapa do percurso da Corrida Passos que Alimentam" src="https://www.google.com/maps?q=-12.996842,-38.442875&z=14&output=embed" loading="lazy" /><div className="route-map-overlay" aria-hidden="true"><svg viewBox="0 0 100 100" preserveAspectRatio="none"><path d="M24 66 C33 64 42 55 50 43 C59 31 68 22 76 15 C68 25 59 35 51 46 C42 58 33 67 24 70" /></svg><span className="map-route-label map-route-meeting">ENCONTRO</span><span className="map-route-label map-route-start">LARGADA</span><span className="map-route-label map-route-turn">RETORNO</span><i className="map-route-dot dot-meeting" /><i className="map-route-dot dot-start" /><i className="map-route-dot dot-turn" /></div></div>
