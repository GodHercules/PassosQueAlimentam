        ...
        <section className="road-stop-section map-stop" id="largada">
          <div className="container route-briefing">
            ...
            <div className="route-briefing-grid">
              <div className="map-frame"><iframe title="Mapa do percurso da Corrida Passos que Alimentam" src="https://www.google.com/maps?q=-12.996842,-38.442875&z=14&output=embed" loading="lazy" /><div className="route-map-overlay" aria-hidden="true"><svg viewBox="0 0 100 100" preserveAspectRatio="none"><path d="M24 78 C38 72 52 63 61 53 S75 28 84 17 S75 39 63 57 S45 72 24 78" /></svg><span className="map-route-label map-route-meeting">ENCONTRO</span><span className="map-route-label map-route-start">LARGADA</span><span className="map-route-label map-route-turn">RETORNO</span><i className="map-route-dot dot-meeting" /><i className="map-route-dot dot-start" /><i className="map-route-dot dot-turn" /></div></div>
